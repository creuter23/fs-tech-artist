#Tony Sakson
#SAL_GradingScript_Project_05_v3.py

#How to run:
#	import SAL_GradingScript_Project_05_v3
#	reload (SAL_GradingScript_Project_05_v3)
#
...
def windowGUI():
	window = cmds.window('TSakson SAL Grading Script Project 05 - Ray Trace Materials')
...
def updateGradeTotal(*args):
	...
	cmds.intFieldGrp( "gradeIntField", e=1, value1=((lightGradeTotal*.3)+(mateTextGradeTotal*.3)+(rayTraceGradeTotal*.4)))
...
def lightingFunction():
	...
	lightGroup1 = cmds.radioButtonGrp( "lightButGrp1", numberOfRadioButtons=3, label='Lighting (30%)', labelArray3=['A+ -A', 'B+ -B', 'C+ -C'], onCommand=lightingButton1 )
...
def mateTextures():
	...
	mateTextGroup1 = cmds.radioButtonGrp( "mateTextButGrp1", numberOfRadioButtons=3, label='Materials & Textures (30%)', labelArray3=['A+ -A', 'B+ -B', 'C+ -C'], onCommand=mateTextButton1 )
