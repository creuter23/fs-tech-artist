#Tony Sakson
#SAL_GradingScript_Project_06_v3.py

#How to run:
#	import SAL_GradingScript_Project_06_v3
#	reload (SAL_GradingScript_Project_06_v3)
#
...
def windowGUI():
	window = cmds.window('TSakson SAL Grading Script Project 06 - Italian Villa')
...
def updateGradeTotal(*args):
	...
	global mateTextGradeTotal
	global rayTraceGradeTotal
	...
	mateTextGradeTotal=cmds.intFieldGrp( "mateTextIntField", q=1, value1=1)
	rayTraceGradeTotal=cmds.intFieldGrp( "rayTraceIntField", q=1, value1=1)
	proGradeTotal=cmds.intFieldGrp( "proIntField", q=1, value1=1)
	
	cmds.intFieldGrp( "gradeIntField", e=1, value1=((lightGradeTotal*.34)+(mateTextGradeTotal*.33)+(rayTraceGradeTotal*.33)))
	gradeTotal=cmds.intFieldGrp( "gradeIntField", q=1, value1=1)
	cflDeductGradeTotal=cmds.intFieldGrp( "cflDeductGradeIntField", e=1, value1=(cflGradeTotal*.1))
	cflDisplayGradeTotal=cmds.intFieldGrp( "cflDeductGradeIntField", q=1, value1=1)
	aanDeductGradeTotal=cmds.intFieldGrp( "aanDeductGradeIntField", e=1, value1=(aanqGradeTotal*.1))
...
# Queries the Grade comments for output
	...
	rayTraceTSListOutput=cmds.scrollField("rayTraceTSList", q=1, tx=1)
...
# Formats the comments for output	
	...
	sceneFileOutput.write("\r\n")
	sceneFileOutput.write("Materials & Textures Comments: "+mateTextTSListOutput+"\r\n")
	sceneFileOutput.write("Materials and Textures Grade: "+str(mateTextGradeTotal)+"\r\n")
	sceneFileOutput.write("\r\n")
	sceneFileOutput.write("Raytracing Comments: "+rayTraceTSListOutput+"\r\n")
	sceneFileOutput.write("Raytracing Grade: "+str(rayTraceGradeTotal)+"\r\n")
	sceneFileOutput.write("\r\n")
	...
	sceneFileOutput.write("-----------------------------------\r\n")
	sceneFileOutput.write("Comp/Focal Len Deductions (10%): -"+str(cflDisplayGradeTotal)+"\r\n")
	sceneFileOutput.write("Alias/Noise Deductions (10%): -"+str(aanqDisplayGradeTotal)+"\r\n")
...
def lightingButton1(*args):
	lightingA="Renders show exemplary understanding of light and shadows. The lighting directs the viewers eye to the subject matter instantaneously. The lighting has a strong style based on cinema reference."
	lightingB="Renders show an acceptable understanding of lighting.  The lighting directs the viewer's eye to the subject after a few seconds of viewing the image. The lighting has a style based on a cinema reference."
	lightingC="Renders show a basic understanding of lighting. The lighting directs the views eye to the subject after a 5 seconds of viewing the image. The lighting has a vague style based on a cinema reference."
...
def lightingButton2(*args):
	lightingD="Renders show below average understanding of lighting.  The lighting does not direct the viewer's eye to the subject. No lighting style based on cinema reference."
	lightingF="Renders show unsatisfactory understanding of lighting.  A strong lack of appeal of lighting direction and complete lack of style based on cinema reference."
...
# Create the Material and Textures Row 1 button, comments and grade functions
def mateTextButton1(*args):
	mateTextA="Renders display student's ability to create exemplary appeal through use of  textural & material believable. Materials are appropriate to their objects. Textures are completely believable and show no signs of pixelization."
	mateTextB="Renders display student's ability to create appeal through textural & material believability. Materials and Textures are above satisfactory in their believability and show no signs of pixelization."
	mateTextC="Renders display student's basic understanding of textural & material believability. Materials and Textures are just satisfactory in their  believability. Textures show mild signs of pixelization."
	mateTextRow1=cmds.radioButtonGrp( "mateTextButGrp1", q=1, sl=1)
	if (mateTextRow1 ==1):
		cmds.intFieldGrp( "mateTextIntField", e=1, value1=100)
		cmds.scrollField("mateTextTSList", e=1, cl=1)
		cmds.scrollField("mateTextTSList", e=1, insertText=mateTextA)
		updateGradeTotal()
	elif (mateTextRow1 ==2):
		cmds.intFieldGrp( "mateTextIntField", e=1, value1=89)
		cmds.scrollField("mateTextTSList", e=1, cl=1)
		cmds.scrollField("mateTextTSList", e=1, insertText=mateTextB)
		updateGradeTotal()
	else:
		cmds.intFieldGrp( "mateTextIntField", e=1, value1=79)
		cmds.scrollField("mateTextTSList", e=1, cl=1)
		cmds.scrollField("mateTextTSList", e=1, insertText=mateTextC)
		updateGradeTotal()
		
# Create the Material and Textures Row 2 button, comments and grade functions		
def mateTextButton2(*args):
	mateTextD="Student needs improvement in the use textural & material believability.  Materials and Textures are just below satisfactory in their  believability. Textures show barely acceptable signs of pixelization."
	mateTextF="Student lacks understanding in the use of textural & material believability. Materials and Textures are un-satisfactory in their  believability. Textures show severe signs of pixelization."
	mateTextRow2=cmds.radioButtonGrp( "mateTextButGrp2", q=1, sl=1)
	if (mateTextRow2 ==1):
		cmds.intFieldGrp( "mateTextIntField", e=1, value1=72)
		cmds.scrollField("mateTextTSList", e=1, cl=1)
		cmds.scrollField("mateTextTSList", e=1, insertText=mateTextD)
		updateGradeTotal()
	else:
		cmds.intFieldGrp( "mateTextIntField", e=1, value1=69)
		cmds.scrollField("mateTextTSList", e=1, cl=1)
		cmds.scrollField("mateTextTSList", e=1, insertText=mateTextF)
		updateGradeTotal()
		
# Create the Raytracing Row 1 button, comments and grade functions
def rayTraceButton1(*args):
	rayTraceA="No noise or any signs of black holes."
	rayTraceB="Slight noise and no signs of black holes."
	rayTraceC="Mild noise, and mild signs of black holes."
	rayTraceRow1=cmds.radioButtonGrp( "rayTraceButGrp1", q=1, sl=1)
	if (rayTraceRow1 ==1):
		cmds.intFieldGrp( "rayTraceIntField", e=1, value1=100)
		cmds.scrollField("rayTraceTSList", e=1, cl=1)
		cmds.scrollField("rayTraceTSList", e=1, insertText=rayTraceA)
		updateGradeTotal()
	elif (rayTraceRow1 ==2):
		cmds.intFieldGrp( "rayTraceIntField", e=1, value1=89)
		cmds.scrollField("rayTraceTSList", e=1, cl=1)
		cmds.scrollField("rayTraceTSList", e=1, insertText=rayTraceB)
		updateGradeTotal()
	else:
		cmds.intFieldGrp( "rayTraceIntField", e=1, value1=79)
		cmds.scrollField("rayTraceTSList", e=1, cl=1)
		cmds.scrollField("rayTraceTSList", e=1, insertText=rayTraceC)
		updateGradeTotal()
		
# Create the Raytracing Row 2 button, comments and grade functions		
def rayTraceButton2(*args):
	rayTraceD="Medium display of noise, and black holes."
	rayTraceF="Severe display of noise, and black holes."
	rayTraceRow2=cmds.radioButtonGrp( "rayTraceButGrp2", q=1, sl=1)
	if (rayTraceRow2 ==1):
		cmds.intFieldGrp( "rayTraceIntField", e=1, value1=72)
		cmds.scrollField("rayTraceTSList", e=1, cl=1)
		cmds.scrollField("rayTraceTSList", e=1, insertText=rayTraceD)
		updateGradeTotal()
	else:
		cmds.intFieldGrp( "rayTraceIntField", e=1, value1=69)
		cmds.scrollField("rayTraceTSList", e=1, cl=1)
		cmds.scrollField("rayTraceTSList", e=1, insertText=rayTraceF)
		updateGradeTotal()
...
def lightingFunction():
	...
	lightGroup1 = cmds.radioButtonGrp( "lightButGrp1", numberOfRadioButtons=3, label='Lighting (34%)', labelArray3=['A+ -A', 'B+ -B', 'C+ -C'], onCommand=lightingButton1 )
...
# Materials and Textures radio button, textScrollList and intField Function
def mateTextures():
	global mateTextSeparator
	mateTextGroup1 = cmds.radioButtonGrp( "mateTextButGrp1", numberOfRadioButtons=3, label='Materials & Textures (33%)', labelArray3=['A+ -A', 'B+ -B', 'C+ -C'], onCommand=mateTextButton1 )
	mateTextGroup2 = cmds.radioButtonGrp( "mateTextButGrp2", numberOfRadioButtons=2, shareCollection=mateTextGroup1, label='', labelArray2=['D', 'F'], onCommand=mateTextButton2  )
	cmds.formLayout( gradeFrm, edit=1, attachForm=[mateTextGroup1, "left", 5], attachControl=[mateTextGroup1, "top", 5, lightSeparator])
	cmds.formLayout( gradeFrm, edit=1, attachForm=[mateTextGroup2, "left", 5, ], attachControl=[mateTextGroup2, "top", 5, mateTextGroup1])
	mateTextShapeField=cmds.intFieldGrp( "mateTextIntField", numberOfFields=1, label='Grade', changeCommand=updateGradeTotal)
	mateTextTextScrollList=cmds.scrollField("mateTextTSList", w=200, h=150, wordWrap=1)
	mateTextCommentsLabel=cmds.text( label='Comments' )
	cmds.formLayout( gradeFrm, edit=1, attachForm=[mateTextShapeField, "top", 5], attachControl=[mateTextShapeField, "top", 10, mateTextGroup2])
	cmds.formLayout( gradeFrm, edit=1, attachForm=[mateTextTextScrollList, "left", 140], attachControl=[mateTextTextScrollList, "top", 10, mateTextShapeField])
	cmds.formLayout( gradeFrm, edit=1, attachForm=[mateTextCommentsLabel, "left", 60], attachControl=[mateTextCommentsLabel, "top", 10, mateTextShapeField])
	mateTextSeparator=cmds.separator( height=15, width=460, style='in' )
	cmds.formLayout( gradeFrm, edit=1, attachForm=[mateTextSeparator, "left", 5], attachControl=[mateTextSeparator, "top", 5, mateTextTextScrollList])

# Raytracing radio button, textScrollList and intField Function
def rayTracing():
	global rayTraceSeparator
	rayTraceGroup1 = cmds.radioButtonGrp( "rayTraceButGrp1", numberOfRadioButtons=3, label='Raytracing (33%)', labelArray3=['A+ -A', 'B+ -B', 'C+ -C'], onCommand=rayTraceButton1 )
...
def compFocalLength():
	global cflSeparator
	cflGroup1 = cmds.radioButtonGrp( "cflButGrp1", numberOfRadioButtons=3, label='Comp/Focal Length (-10%)', labelArray3=['A+ -A', 'B+ -B', 'C+ -C'], onCommand=compFocalButton1 )
	...
	cmds.formLayout( gradeFrm, edit=1, attachForm=[cflGroup1, "left", 5], attachControl=[cflGroup1, "top", 5, rayTraceSeparator])
...
def antiAliasNoiseQual():
	...
	aanqGroup1=cmds.radioButtonGrp( "aanqRadButGrp1", numberOfRadioButtons=3, label='Anitalias/Noise Qual (-10%)', labelArray3=['A+ -A', 'B+ -B', 'C+ -C'], onCommand=antiAliasButton1)
