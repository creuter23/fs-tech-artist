#Tony Sakson
#SAL_GradingScript_Project_04_v3.py

#How to run:
#	import SAL_GradingScript_Project_04_v3
#	reload (SAL_GradingScript_Project_04_v3)
#
...
def windowGUI():
	window = cmds.window('TSakson SAL Grading Script Project 04 - Picnic with Watermelon')
...
def updateGradeTotal(*args):
	...
	cmds.intFieldGrp( "gradeIntField", e=1, value1=((lightGradeTotal*.5)+(mateTextGradeTotal*.5)))
...
# Formats the comments for output	
	...
	sceneFileOutput.write("\r\n")
	sceneFileOutput.write("Materials and Textures Comments: "+mateTextTSListOutput+"\r\n")
...
def mateTextButton1(*args):
	mateTextA="Renders display student's ability to create exemplary appeal through use of textural & material believable. Materials are appropriate to their objects. Textures are completely beilievable and show no signs of procedural quality."
	mateTextB="Renders display student's ability to create appeal through textural & material believability. Materials and Textures are above satisfactory in their believability and show no signs of procedural quality."
	mateTextC="Renders display student's basic understanding of textural & material believability. Materials and Textures are just satisfactory in their  believability. Textures show mild signs of procedural quality."
...
def mateTextButton2(*args):
	mateTextD="Student needs improvement in the use textural & material believability. Materials and Textures are just below satisfactory in their  believability. Textures show barely acceptable signs of procedural quality."
	mateTextF="Student lacks understanding in the use of textural & material believability. Materials and Textures are un-satisfactory in their  believability. Textures show severe signs of procedural quality."
...
def lightingFunction():
	...
	lightGroup1 = cmds.radioButtonGrp( "lightButGrp1", numberOfRadioButtons=3, label='Lighting (50%)', labelArray3=['A+ -A', 'B+ -B', 'C+ -C'], onCommand=lightingButton1 )
...
def mateTextures():
	...
	mateTextGroup1 = cmds.radioButtonGrp( "mateTextButGrp1", numberOfRadioButtons=3, label='Materials & Textures (50%)', labelArray3=['A+ -A', 'B+ -B', 'C+ -C'], onCommand=mateTextButton1 )
...
def compFocalLength():
	...
	cmds.formLayout( gradeFrm, edit=1, attachForm=[cflGroup1, "left", 5], attachControl=[cflGroup1, "top", 5, mateTextSeparator])
