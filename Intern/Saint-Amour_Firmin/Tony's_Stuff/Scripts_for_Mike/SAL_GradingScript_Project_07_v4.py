#Tony Sakson
#SAL_GradingScript_Project_07_v4.py

#How to run:
#	import SAL_GradingScript_Project_07_v4
#	reload (SAL_GradingScript_Project_07_v4)
#
...
def windowGUI():
	window = cmds.window('TSakson SAL Grading Script Project 07 - Compositing, Motion Blur & SSS')
