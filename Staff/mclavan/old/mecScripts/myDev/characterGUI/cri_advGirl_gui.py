...
iconCharPath = os.path.join(imgPath[0], "images", "characterSel_icons")
iconPath = os.path.join(imgPath[0], "images", "other_icons")
...
def gui():
	...
	cmds.window(win, title="Adventure Girl", w=winWidth, h=winHeight)
