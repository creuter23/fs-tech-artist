...
def export_button(*args):
    ...
    # Move to correct sheet , sheet 5
    # Move to correct cell (column 36, row 6)
    # var.write(row, column, value)
    # var.save(excel_file_name.xls)
    
    
    file_name = '/Users/critnkitten/Desktop/output.xls'
    ...
    wb.get_sheet(0).write(0,0,'changed... NOT AGAIN')
    wb.get_sheet(0).write(5,5, '<3')    
    wb.save('/Users/critnkitten/Desktop/output.xls')
