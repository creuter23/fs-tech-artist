...
class Widget_One():
    ...
    def remove_object(self, obj):
        remove_num = self.objs.index(obj)
...
class Main_Widget():
    def __init__(self, name, objs, comments, pf, bg_color=[1,0,0]):
        ...
        self.grade_widget = Widget_Two(comments, pf)
...
def gui():
    ...
    cmds.tabLayout(tabs, edit=True, tabLabel=[(tab1, 'Summary'), (tab2, 'Grading')])
