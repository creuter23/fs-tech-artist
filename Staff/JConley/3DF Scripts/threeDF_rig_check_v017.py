...
class Widget_Two():
    def __init__(self, objs, comment_file, pf):
        ...
        #argument for which text file to open / read, need to pass into comment class
...
class Main_Widget():
    def __init__(self, name, objs, comment_file, pf, bg_color=[1,0,0]):      
        
        self.mainFrame = cmds.frameLayout(l='%s - %s' % (name, len(objs)), bgc=bg_color, cll=True, w=frame)
        if not objs:
        ...
        self.grade_widget = Widget_Two(objs, comment_file, pf)
...
def gui():
    ...
    main_widget1 = Main_Widget('Joint Naming - Invalid', check_joint_naming(cmds.ls(typ='joint')), '/Users/critnkitten/Library/Preferences/Autodesk/maya/scripts/3DF_Rig_Comments/joint_naming.txt', pf=1)
    cmds.setParent(joint_col)    
    main_widget2 = Main_Widget('Joint Rotations - Invalid', check_joint_rotates(cmds.ls(typ='joint')), '/Users/critnkitten/Library/Preferences/Autodesk/maya/scripts/3DF_Rig_Comments/joint_transforms.txt', pf=1)
    cmds.setParent(joint_col)
    main_widget3 = Main_Widget('Joint Translates - Warning', check_joint_translates(cmds.ls(typ='joint')), '/Users/critnkitten/Library/Preferences/Autodesk/maya/scripts/3DF_Rig_Comments/joint_transforms.txt', pf=1)
    cmds.setParent(joint_col)    
    ...
    cmds.frameLayout(l='Curves', cll=True, w=frame)
    curve_col = cmds.columnLayout()
    main_widget5 = Main_Widget('Curve Naming - Invalid', check_curve_naming(cmds.ls(typ='nurbsCurve')), '/Users/critnkitten/Library/Preferences/Autodesk/maya/scripts/3DF_Rig_Comments/curve_naming.txt', pf=1)
    cmds.setParent(curve_col) 
    main_widget6 = Main_Widget('Curve Transforms - Invalid', check_transforms(cmds.ls(typ='nurbsCurve')), '/Users/critnkitten/Library/Preferences/Autodesk/maya/scripts/3DF_Rig_Comments/curve_transforms.txt', pf=1)
    cmds.setParent(curve_col) 
    main_widget7 = Main_Widget('Curve History - Invalid', check_curve_hist(cmds.ls(typ='nurbsCurve')), '/Users/critnkitten/Library/Preferences/Autodesk/maya/scripts/3DF_Rig_Comments/curve_history.txt', pf=1)
    cmds.setParent(main)
    ...
    cmds.frameLayout(l='Geometry', cll=True, w=frame)
    geo_col = cmds.columnLayout()
    main_widget8 = Main_Widget('Geo Naming - Invalid', check_geo_naming(cmds.ls(typ='mesh')), '/Users/critnkitten/Library/Preferences/Autodesk/maya/scripts/3DF_Rig_Comments/geo_naming.txt', pf=1)
    cmds.setParent(geo_col)
    main_widget9 = Main_Widget('Geo Transforms - Invalid', check_transforms(cmds.ls(typ='mesh')), '/Users/critnkitten/Library/Preferences/Autodesk/maya/scripts/3DF_Rig_Comments/geo_transforms.txt', pf=1)
    cmds.setParent(geo_col)
    main_widget10 = Main_Widget('Geo History - Invalid', check_geo_hist(cmds.ls(typ='mesh')), '/Users/critnkitten/Library/Preferences/Autodesk/maya/scripts/3DF_Rig_Comments/geo_history.txt', pf=1)    
    cmds.setParent(main)
