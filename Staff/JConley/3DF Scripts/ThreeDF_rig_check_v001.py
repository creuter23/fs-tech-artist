...
def gui():
    ...
    frm1 = Frame_Widget('Joint Rotations - Invalid', check_joint_rotates(cmds.ls(typ='joint')), main)
    
    
    #frm2 = Frame_Widget('Joint Translations - Invalid', check_joint_translations(cmds.ls(typ='joint')), main)
