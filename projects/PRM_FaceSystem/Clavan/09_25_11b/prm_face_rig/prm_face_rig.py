...
def gui():
    ...
    cmds.frameLayout(label="Mouth Shapes", w=314, h=frame_heigth, bgc=[.52, .47, .4])
    cmds.scrollLayout()
    ...
    cmds.frameLayout(label="Eye Lid Shapes", w=314, h=frame_heigth, bgc=[.52, .47, .4])
    cmds.scrollLayout()    
    ...
    cmds.frameLayout(label="Eye Brow Shapes", w=314, h=frame_heigth, bgc=[.52, .47, .4])
    cmds.scrollLayout()    
